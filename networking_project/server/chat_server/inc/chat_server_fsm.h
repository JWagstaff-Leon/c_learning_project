...
typedef enum
{
    ...
    CHAT_SERVER_MESSAGE_AUTH_DATABASE_OPENED,
    CHAT_SERVER_MESSAGE_AUTH_DATABASE_OPEN_FAILED,
    CHAT_SERVER_MESSAGE_AUTH_DATABASE_CLOSED,
    CHAT_SERVER_MESSAGE_AUTH_DATABASE_CLOSE_FAILED,
    CHAT_SERVER_MESSAGE_AUTH_RESULT,
    CHAT_SERVER_MESSAGE_AUTH_TRANSACTION_DONE
