...
typedef enum
{
    ...
    CHAT_EVENT_IO_RESULT_FLUSH_REQUIRED       = 1 <<  7,
    CHAT_EVENT_IO_RESULT_FLUSH_FINISHED       = 1 <<  8,
    CHAT_EVENT_IO_RESULT_POPULATE_SUCCESS     = 1 <<  9,
    CHAT_EVENT_IO_RESULT_POPULATE_FAILED      = 1 << 10,

    CHAT_EVENT_IO_RESULT_CLOSED               = 1 << 30,
    CHAT_EVENT_IO_RESULT_UNDEFINED            = 1 << 31
} eCHAT_EVENT_IO_RESULT;
