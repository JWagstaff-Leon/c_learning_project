...
static const fEVENT_HANDLER event_handler_table[] = {
    ...
    handler_username_rejected, // CHAT_EVENT_USERNAME_REJECTED
    handler_password_request,  // CHAT_EVENT_PASSWORD_REQUEST
    handler_no_op,             // CHAT_EVENT_PASSWORD_SUBMIT
    handler_password_rejected, // CHAT_EVENT_PASSWORD_REJECTED
    handler_authenticated,     // CHAT_EVENT_AUTHENTICATED
    handler_user_join,         // CHAT_EVENT_USER_JOIN
