...
typedef enum
{
    CHAT_CONNECTION_MESSAGE_WATCH_COMPLETE,
    CHAT_CONNECTION_MESSAGE_WATCH_CANCELLED,
    CHAT_CONNECTION_MESSAGE_WATCHER_CLOSED,

    CHAT_CONNECTION_MESSAGE_QUEUE_EVENT,

    CHAT_CONNECTION_MESSAGE_CLOSE,
    CHAT_CONNECTION_MESSAGE_CLOSE_IMMEDIATELY
